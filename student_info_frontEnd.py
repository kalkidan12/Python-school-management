               ...
               #==========================================================Functions====================================================================
                     ...
                     def Add():
                            if(len(self.name.get()) != 0):
                               student_info_BackEnd.insert(self.name.get(), self.fname.get(), self.mname.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(), \
                                                       self.gender.get())
                     ...
                     def Display():
                               self.listbox.delete(0, END)
                               for row in student_info_BackEnd.view():
                     ...
                     def Delete():
                            if(len(self.name.get()) != 0):
                               student_info_BackEnd.delete(selected_tuple[0])
                               Reset()
                               Display()
                     ...
                     def Search():
                            self.listbox.delete(0, END)
                            for row in student_info_BackEnd.search(self.name.get(), self.fname.get(), self.mname.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(),self.gender.get()):
                                   self.listbox.insert(END, row, str(' '))
